...
## 元数据
- job_set_id: 93059c32-5f17-49ae-a589-6a3d8bd19e77
- job_type: seedance_2_0
- source_path: folders/Hell Grind/Scene 68/prompts/00108.txt
...
单一连续镜头，总时长 12 秒，变形宽银幕 50mm，胶片颗粒，中等景深，丹尼斯·维伦纽瓦式「沙丘」风格——神圣尺度与亲密观察并存。无剪辑。

[CHARACTERS]（角色）
- ROCO：凌乱蓬松的黑发、淡淡的胡须、脸上带灰、鼻梁贴一条红色小创可贴、深色风化的战术夹克带雪佛龙面板、深色工装裤、右手腕绑红色头巾、露指手套、后腰带上挂红色小熊钥匙扣。
- JAXX：漂白金发、深色皮肤、额头上架透明护目镜、深色战术夹克带灰色面板、橄榄色工装裤、露指手套。
- REIN：银黑波波头、右颧骨有道疤、深灰色短款战术夹克、黑色高领衫、深色宽松工装裤、大腿枪套。
全都沾满灰尘。

[LOCATION]（场景地点）
洞窟-寺庙内部。画面由一扇嵌在粗糙岩壁中的巨型华丽雕刻石门主导。门有一道高挑凹进的矩形开口（风化石材），顶部由一道繁复雕花的拱形门楣（arched header）框起——带卷曲螺旋纹饰与繁复的印度-佛教风格浮雕。沉重的雕花石壁柱（pilasters）立于门两侧。门脚基座处有一级低矮的石阶。门框底部两侧墙角各有一盏小小的陶土油灯蜡烛在燃烧。冷蓝环境光，深阴影。
...
[LIGHT]（灯光）
上方冷蓝环境光落在雕花石上，门脚两盏油灯处升起暖橙烛光池，暖色轮廓光掠上夹克边缘，身后凹进的门口处是深阴影，微尘飘浮于混合光中。
...
[ACTION]（动作）
0.0s——开场落在 ROCO 俯卧在雕花石门前的石阶上，头离摄影机最近，脚贴近门框。华丽的雕花门直接填满整组人正后方的背景。JAXX 站在画面右侧 ROCO 身旁抵着右壁柱，REIN 站在画面左侧 ROCO 身旁抵着左壁柱、左手拿滑板。两人都沉默地看着 ROCO。
...
12.0s——末帧：中景，三人紧贴雕花石门——JAXX 画面右侧抵着右壁柱，ROCO 居中直立、眼神深重疲惫，REIN 画面左侧抵着左壁柱、手持滑板。装饰性拱形门楣直接拱在他们头顶上方。灰尘从 ROCO 夹克上簌簌落下。两盏油灯在地面层的门角发光。
...
[NEGATIVE]（反面清单）
无音乐、无对白、无言语，JAXX 不开口，REIN 不开口，ROCO 不开口，无慢动作，无平滑云台，无航拍镜头，无剪辑，无淡入淡出，无溶接，无其他人，无僧人，无雕像，无发光红线，无变身，无拔武器，无战斗，雕花石门必须**紧贴**在角色正后方——背几乎碰到石面，角色**不在**开放空间中，角色**不**离门 1 米以上，角色与门之间无空的中景地带，身后无宽阔大厅，角色**立在**门槛的石阶上，REIN 绝不放下滑板，JAXX 始终在画面右侧，REIN 始终在画面左侧，ROCO 在地面时头始终指向**摄影机**，ROCO 绝不仰卧，ROCO 开场俯卧在肚子上，ROCO 意识清醒且主要靠自身之力起身、有人搀扶，ROCO 不绵软，ROCO 不失去意识，ROCO 不被拖行，不得摘除红色鼻贴，无文字，无字幕，无标识。

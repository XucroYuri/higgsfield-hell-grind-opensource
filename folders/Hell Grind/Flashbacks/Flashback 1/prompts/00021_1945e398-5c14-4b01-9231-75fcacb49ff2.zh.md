...
## 元数据
- job_set_id: `1945e398-5c14-4b01-9231-75fcacb49ff2`
- job_type: `cinematic_studio_video_3_5`
- source_path: `folders/Hell Grind/Flashbacks/Flashback 1/prompts/00021_1945e398-5c14-4b01-9231-75fcacb49ff2.txt`
...
> 本文件对应索引 `00021`。占位符 `<<<image_N>>>` 与英文技术词（job type、模型名等）不译；关键规则保强度。

...
## 元数据
- job_set_id: `dfbe5981-897a-43f3-94e5-1fbba2542723`
- job_type: `cinematic_studio_video_3_5`
- source_path: `folders/Hell Grind/Flashbacks/Flashback 1/prompts/00024_dfbe5981-897a-43f3-94e5-1fbba2542723.txt`
...
> 本文件对应索引 `00024`。占位符 `<<<image_N>>>` 与英文技术词（job type、模型名等）不译；关键规则保强度。
